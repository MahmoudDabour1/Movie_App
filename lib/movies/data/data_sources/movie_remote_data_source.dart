...
import 'package:movies_with_clean/movies/data/models/movie_details_model.dart';
import 'package:movies_with_clean/movies/data/models/movie_model.dart';
...
class MovieRemoteDataSource extends BaseMovieRemoteDataSource {
  ...
  Future<MovieDetailsModel> getMovieDetails(
    ...
    final response =
        await Dio().get(ApiConstance.moviesDetailsPath(parameters.movieId));
    if (response.statusCode == 200) {
